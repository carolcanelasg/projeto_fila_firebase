...
import ServicoDTO from "/model/ServicoDTO.js";
...
export default class DaoServico {
  ...
  async obterServicoPeloId(id_servico) {
    ...
    return new Promise((resolve) => {
      let dbRefServico = ref(connectionDB,'servicos/' + servico);
      ...
      resultPromise.then(dataSnapshot => {
        dataSnapshot.forEach( (dataSnapshotObj) => {
            ...
            if(gerarDTOs === undefined)
              ...
              conjServicos.push(new ServicoDTO(new Servico(elem.nome_servico,elem.quantidade_atendimento,elem.id_servico)));
            });
        });
    });
  }
  ...
  async incluir(servico) {
    ...
    let resultado = new Promise( (resolve, reject) => {
      ...
      runTransaction(dbRefServicos, (servicos) => {       
        let dbRefNovoServico = child(dbRefServicos,servico.getSigla());
  ...
  async alterar(servico) {
    ...
    let resultado = new Promise( (resolve, reject) => {   
      ...
      runTransaction(dbRefCursos, (servicos) => {       
        let dbRefAlterarServico = child(dbRefServicos, servico.getSigla());
  ...
  async excluir(servico) {
    ...
    let resultado = new Promise( (resolve, reject) => {   
      ...
      runTransaction(dbRefServico, (servicos) => {       
        let dbRefExcluirServico = child(dbRefServico,servico.getSigla());
